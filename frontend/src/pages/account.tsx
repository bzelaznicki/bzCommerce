                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-gray-50 p-4 rounded-md shadow-sm">
                                    ...
                                    <p className="text-lg font-medium text-gray-900">{formatDate(account.createdAt)}</p>
                                </div>
                                <div className="bg-gray-50 p-4 rounded-md shadow-sm">
                                    <p className="text-sm font-semibold text-gray-500">Last Updated</p>
                                    <p className="text-lg font-medium text-gray-900">{formatDate(account.updatedAt)}</p>
                                </div>
                            </div>
